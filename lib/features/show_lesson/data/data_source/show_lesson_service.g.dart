...
class _ShowLessonService implements ShowLessonService {
  ...
  Future<HttpResponse<EitherResultDto>> quizCheckRoute({
    required int quizId,
    required Map<String, dynamic> quizCheckBody,
  }) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(quizCheckBody);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<EitherResultDto>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = EitherResultDto.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
