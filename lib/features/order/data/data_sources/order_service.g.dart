...
class _OrderService implements OrderService {
  ...
  @override
  Future<HttpResponse<PaymentTypeDto>> getPaymentTypes() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<PaymentTypeDto>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaymentTypeDto _value;
    try {
      _value = PaymentTypeDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<CardNumberDto>> getCardNumber() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<CardNumberDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment/get-card',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CardNumberDto _value;
    try {
      _value = CardNumberDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<SendOtpDto>> sendOtp({
    ...
    final _options = _setStreamType<HttpResponse<SendOtpDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment/send-otp',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SendOtpDto _value;
    try {
      _value = SendOtpDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<VerifyOtpDto>> verifyOtp({
    ...
    final _options = _setStreamType<HttpResponse<VerifyOtpDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment/verify-otp',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VerifyOtpDto _value;
    try {
      _value = VerifyOtpDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
