...
class _HomeService implements HomeService {
  ...
  Future<HttpResponse<DefaultResponse<AllCourseDto>>> getAllCourse() async {
    ...
    final _options =
        _setStreamType<HttpResponse<DefaultResponse<AllCourseDto>>>(
    ...
    late DefaultResponse<AllCourseDto> _value;
    try {
      _value = DefaultResponse<AllCourseDto>.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<DataResponse<CourseDetailsDto>>> getCourseDetails({
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<DataResponse<CourseDetailsDto>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/course-detail/${slug}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DataResponse<CourseDetailsDto> _value;
    try {
      _value = DataResponse<CourseDetailsDto>.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<DefaultResponse<LessonByCourseDto>>> getLesson({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DefaultResponse<LessonByCourseDto> _value;
    try {
      _value = DefaultResponse<LessonByCourseDto>.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
