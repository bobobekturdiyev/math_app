...
class _ProfileService implements ProfileService {
  ...
  Future<HttpResponse<DefaultResponse<PlanDto>>> getAllPlan() async {
    ...
    final _options = _setStreamType<HttpResponse<DefaultResponse<PlanDto>>>(
    ...
    late DefaultResponse<PlanDto> _value;
    try {
      _value = DefaultResponse<PlanDto>.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<DataResponse<AllInfoDto>>> getUserData() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<DataResponse<AllInfoDto>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/all-info',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DataResponse<AllInfoDto> _value;
    try {
      _value = DataResponse<AllInfoDto>.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<DefaultResponse<SkillsDto>>> getSkills({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<DefaultResponse<SkillsDto>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/get-skill/${text}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DefaultResponse<SkillsDto> _value;
    try {
      _value = DefaultResponse<SkillsDto>.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<DefaultResponse<BalanceHistoryDto>>>
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DefaultResponse<BalanceHistoryDto> _value;
    try {
      _value = DefaultResponse<BalanceHistoryDto>.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<PayDto>> payFromBalance({
    ...
    final _options = _setStreamType<HttpResponse<PayDto>>(
    ...
    late PayDto _value;
    try {
      _value = PayDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<UpdatePasswordDto>> updatePassword({
    required UpdatePasswordReq updatePasswordReq,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<HttpResponse<UpdatePasswordDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdatePasswordDto _value;
    try {
      _value = UpdatePasswordDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<ResponseDto>> addSkills({
    ...
    final _options = _setStreamType<HttpResponse<ResponseDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/portfolio-skill',
